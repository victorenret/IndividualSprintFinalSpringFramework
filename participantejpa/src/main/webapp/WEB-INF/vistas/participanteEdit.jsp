...
<link rel="stylesheet" href="<c:url value="/res/css/estyles.css" />">
</head>
...
<body>
	...
	<div align="center">
		...
		<form:form action="crearParticipante" method="post"
			modelAttribute="participante">
			<table class="editParti" border="0" cellpadding="5">
				<tr>
					<td>ID:</td>
					<td>${participante.id}<form:hidden path="id" /></td>
				</tr>
				<tr>
					<td>Nombre:</td>
